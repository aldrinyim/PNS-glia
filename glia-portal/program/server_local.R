...
datasetchosen <- reactive({switch(input$scrnadata,'Sciatic nerve atlas'='program/data/sciatic_v2_SHINY-16May2021.RDS','Schwann cells'='program/data/sciaticv23-finalzed_SHINY-16May2021.RDS','Immune cells'='program/data/immune_SHINY-16May2021.RDS')})
#datasetchosen <- reactive({switch(input$scrnadata,'Schwann cells'='program/data/sciaticv23-finalzed_SHINY-16Jan2021.RDS','Immune cells'='program/data/immune-shiny-15Jan2021.RDS')})
...
observeEvent(input$actionButton, {
    ...
    input_file = dataset
    input_file$datapath = dataset
    input_file$name = str(strsplit(dataset,'/')[[1]][3])
    
    #input_file = 'program/data/sciaticv23-shiny-Seurat321.RDS'
    #input_file$name = 'sciaticv23-shiny-Seurat321.RDS'
    #input_file$datapath = 'program/data/sciaticv23-shiny-Seurat321.RDS'
...
#load_data_result <- load_data(file)
#error_messages   <- load_data_result[["errors"]]
#if (is.null(error_messages)) {
#    userData$objectId       <- userData$objectId + 1
#    userData$object         <- load_data_result[["object"]]
